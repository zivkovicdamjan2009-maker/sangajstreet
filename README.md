...
- jela: prazna polja pokazuju putanju (`assets/food/02.jpg`, `07.jpg` … `12.jpg`); popunjene kartice već imaju slike (`sangaj-specijal.png`, `hrskava-piletina.png`, `gurmanski-sis.png`, `smash-burger.png`, `cepkano-prase.png`)
